...
class Motor: public PID {
  ...
  public:
    ...
    void run() {
      calculateSpeed();
      analogWrite(p.IN1, basePWM + calculateOutput(targetSpeed, speed));
      analogWrite(p.IN2, 0);
    }
    pins getPins() {
      return p;
